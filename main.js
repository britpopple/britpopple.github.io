var app = (function() {
        ...
        c() {
          ...
          Q(i.$$.fragment),
            ...
            M(
              u,
              "class",
              "font-serif text-3xl font-bold flex-grow text-center flex-2"
            ),
        ...
        function() {
          y.getCurrentSound(function(e) {
            ...
            y.bind(SC.Widget.Events.PLAY_PROGRESS, function(e) {
              n(11, (w = Math.max(e.currentPosition - h.startAtMs, 0))),
                1 == s ?
                p.isPrime ?
  ...
  function Nt(t) {
    ...
    return {
      c() {
        (n = w("div")),
        (n.innerHTML =
          '<p class="mb-3">A clone of <a target="_blank" href="https://www.heardle.app/" title="Heardle">Heardle</a> for Britpop fans.</p>'
           + '<p class="mb-3">Think you know your Britpop? Name that British indie pop song from the intro as quickly as you can</p>'
           + '<p class="mb-3"> </p>'
           + '<p class="mb-3">Follow us on Twitter <a target="_blank" href="https://twitter.com/Britpopple">@Britpopple</a></p>'
           + '<p class="mb-3"> </p>'
           + '<p class="text-xs mb-3 text-custom-line">All copyright owned by the relevant parties.</p>'
           + '<p class="mb-3"> </p>'
           + '<p class="text-xs mb-3 text-custom-line">Prepared with <a target="_blank" href="https://developers.soundcloud.com">SoundCloud</a> and powered by <a target="_blank" href="https://glitch.com/">Glitch</a>. Logo courtesy of <a target="_blank" href="https://www.flickr.com/photos/dannypigart/2535963283/">dannypigart</a>. See the source code <a target="_blank" href="https://glitch.com/edit/#!/britpopple">here</a>.'),
        M(n, "class", "text");
      },
      m(e, t) {
        g(e, n, t);
  ...
  function It(t) {
    ...
    return {
      c() {
        ...
        (r = w("a")),
        (r.innerHTML =
          '<span class="kofitext text-sm svelte-1d3p4dy"><img src="https://storage.ko-fi.com/cdn/cup-border.png" alt="Ko-fi donations" class="kofiimg mr-2 mb-1 svelte-1d3p4dy"/>Love Britpopple? Say thanks with a coffee!</span><svg xmlns="http://www.w3.org/2000/svg" class="ml-2" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M5 12h13M12 5l7 7-7 7"></path></svg>'),
        M(
            r,
            "class",
            "kofi-button py-2 px-3 rounded-lg items-center flex  svelte-1d3p4dy"
          ),
          M(r, "href", "https://ko-fi.com/hazey88"),
          M(r, "title", "Love Britpopple? Buy me a coffee on Ko-fi"),
          M(r, "target", "_blank"),
          M(
            n,
            "class",
    ...
    return (
      ...
      (u = new Bt({})), {
        c() {
          ...
          (s = w("p")),
          (n.innerHTML =
            "If you like Britpopple, please help keep us fully caffeinated..."),
          (r = x()),
          (s = w("p")),
          (i = x()),
          (o = w("div")),
  ...
  const Vt = {
    ...
    Jt = ["Why Does It Always Rain On Me?", "This Is The One", "Great Things", "All You Good Good People", "Fine Time", "Alright", "What Took You So Long?"];
      ...
      (O = new Rt({})), {
        c() {
          ...
          W.c(),
            ...
            (m = w("div")),
            (k = w("div")),
            (k.textContent = "Next Britpopple in:"),
            (b = x()),
            Q(S.$$.fragment),
            (D = x()),
            (T = w("div")),
  ...
  function an(e) {
    ...
    return {
      c() {
        (t = _("You got today's Britpopple within the first ")),
        (n = _(s)),
        (r = _(" seconds."));
      },
      m(e, s) {
  ...
  function ln(e) {
    ...
    return {
      c() {
        (t = _("You got today's Britpopple within ")),
        (n = _(o)),
        (r = _("\n                second")),
        (s = _(a)),
        (i = _("."));
  ...
  function un(t) {
    ...
    return {
      c() {
        n = _("You didn't get today's Britpopple. Better luck tomorrow!");
      },
      m(e, t) {
        g(e, n, t);
      },
...
"Supergrass - Just Dropped In (To See What My Condition Was In)",
"Dodgy - The Snake",
...
"Blur - Out Of Time",
"Manic Street Preachers - Some Kind Of Nothingness (feat. Ian McCulloch)",
...
{ url: "https://soundcloud.com/gomez-official/get-miles", answer: "Gomez - Get Miles" },
{ url: "https://soundcloud.com/stereophonicsofficial/hurry-up-and-wait", answer: "Stereophonics - Hurry Up And Wait" },
{ url: "https://soundcloud.com/embrace-93530/dry-kids", answer: "Embrace - Dry Kids" },
{ url: "https://soundcloud.com/primalscream/damaged-2", answer: "Primal Scream - Damaged" },
{ url: "https://soundcloud.com/radiohead/exit-music-for-a-film", answer: "Radiohead - Exit Music (For A Film)" },
{ url: "https://soundcloud.com/suede-official/heroine", answer: "Suede - Heroine" },
{ url: "https://soundcloud.com/pulp-official/do-you-remember-the-first", answer: "Pulp - Do You Remember The First Time?" },
{ url: "https://soundcloud.com/thecharlatans/one-to-another", answer: "The Charlatans - One to Another" },
{ url: "https://soundcloud.com/primalscream/jailbird-1", answer: "Primal Scream - Jailbird", startAtMs: 500 },
{ url: "https://soundcloud.com/mcalmont-butler/yes-full-version", answer: "McAlmont & Butler - Yes" },
{ url: "https://soundcloud.com/sleeperofficial/sale-of-the-century", answer: "Sleeper - Sale of the Century" },
{ url: "https://soundcloud.com/embrace-93530/all-you-good-good-people-1", answer: "Embrace - All You Good Good People" },
{ url: "https://soundcloud.com/elastica-official/line-up-1", answer: "Elastica - Line Up", startAtMs: 700 },
{ url: "https://soundcloud.com/paulwellerofficial/you-do-something-to-me", answer: "Paul Weller - You Do Something To Me" },
{ url: "https://soundcloud.com/kula-shaker-official/tattva-2011-remastered", answer: "Kula Shaker - Tattva" },
{ url: "https://soundcloud.com/supergrass-official/richard-iii", answer: "Supergrass - Richard III", startAtMs: 3500 },
{ url: "https://soundcloud.com/the-seahorses/blinded-by-the-sun", answer: "The Seahorses - Blinded By The Sun" },
{ url: "https://soundcloud.com/manicstreetpreachers/motorcycle-emptiness-album", answer: "Manic Street Preachers - Motorcycle Emptiness" },
...
{ url: "https://soundcloud.com/radiohead/high-and-dry", answer: "Radiohead - High and Dry" },
{ url: "https://soundcloud.com/the-verve-official/this-is-music-2004-digital", answer: "The Verve - This Is Music", startAtMs: 1000 },
{ url: "https://soundcloud.com/dubstar-official/not-so-manic-now-1", answer: "Dubstar - Not so Manic Now" },
{ url: "https://soundcloud.com/electronicofficial/getting-away-with-it-2013", answer: "Electronic - Getting Away with It" },
{ url: "https://soundcloud.com/space-the-band/me-and-you-versus-the-world-2", answer: "Space - Me and You Versus the World" },
{ url: "https://soundcloud.com/super-furry-animals/something-4-the-weekend-u-s", answer: "Super Furry Animals - Something 4 the Weekend" },
{ url: "https://soundcloud.com/independiente/travis-why-does-it-always-rain", answer: "Travis - Why Does It Always Rain On Me?" },
{ url: "https://soundcloud.com/gomez-official/get-myself-arrested", answer: "Gomez - Get Myself Arrested" },
{ url: "https://soundcloud.com/menswearofficial/sleeping-in", answer: "Menswear - Sleeping In" },
{ url: "https://soundcloud.com/thecharlatans/cant-get-out-of-bed-1", answer: "The Charlatans - Can't Get Out of Bed", startAtMs: 350 },
{ url: "https://soundcloud.com/primalscream/loaded-3", answer: "Primal Scream - Loaded" },
{ url: "https://soundcloud.com/kula-shaker-official/hey-dude-2011-remastered", answer: "Kula Shaker - Hey Dude" },
{ url: "https://soundcloud.com/supergrass-official/moving", answer: "Supergrass - Moving", startAtMs: 150 },
{ url: "https://soundcloud.com/pulp-official/babies", answer: "Pulp - Babies" },
{ url: "https://soundcloud.com/stereophonicsofficial/pick-a-part-thats-new-1", answer: "Stereophonics - Pick A Part That's New" },
{ url: "https://soundcloud.com/ash/goldfinger-2011-remastered", answer: "ASH - Goldfinger", startAtMs: 500 },
{ url: "https://soundcloud.com/blurofficial/to-the-end", answer: "Blur - To the End" },
{ url: "https://soundcloud.com/athlete-official/wires", answer: "Athlete - Wires" },
{ url: "https://soundcloud.com/the-divine-comedy/something-for-the-weekend-2", answer: "The Divine Comedy - Something for the Weekend", startAtMs: 7800 },
{ url: "https://soundcloud.com/embrace-93530/fireworks", answer: "Embrace - Fireworks" },
{ url: "https://soundcloud.com/elastica-official/connection-1", answer: "Elastica - Connection" },
{ url: "https://soundcloud.com/longpigs/she-said-album-version", answer: "Longpigs - She Said" },
{ url: "https://soundcloud.com/oasisofficial/columbia-remastered", answer: "Oasis - Columbia", startAtMs: 1000 },
{ url: "https://soundcloud.com/radiohead/the-bends", answer: "Radiohead - The Bends", startAtMs: 11200 },
{ url: "https://soundcloud.com/teenagefanclub/sparkys-dream-1", answer: "Teenage Fanclub - Sparky's Dream" },
{ url: "https://soundcloud.com/shed-seven/chasing-rainbows", answer: "Shed Seven - Chasing Rainbows" },
{ url: "https://soundcloud.com/super-furry-animals/hometown-unicorn-2016-remaster", answer: "Super Furry Animals - Hometown Unicorn", startAtMs: 2000 },
{ url: "https://soundcloud.com/primalscream/higher-than-the-sun-higher", answer: "Primal Scream - Higher Than the Sun" },
{ url: "https://soundcloud.com/the-stone-roses/this-is-the-one-remastered", answer: "The Stone Roses - This Is the One" },
{ url: "https://soundcloud.com/supergrass-official/late-in-the-day", answer: "Supergrass - Late In The Day", startAtMs: 1000 },
{ url: "https://soundcloud.com/dodgy-official/staying-out-for-the-summer-1", answer: "Dodgy - Staying Out For The Summer", startAtMs: 8000 },
{ url: "https://soundcloud.com/echobellymusic/great-things-album-version", answer: "Echobelly - Great Things" },
{ url: "https://soundcloud.com/suede-official/trash-2", answer: "Suede - Trash", startAtMs: 800 },
{ url: "https://soundcloud.com/radiohead/paranoid-android", answer: "Radiohead - Paranoid Android" },
{ url: "https://soundcloud.com/dubstar-official/stars", answer: "Dubstar - Stars" },
{ url: "https://soundcloud.com/shed-seven/disco-down", answer: "Shed Seven - Disco Down" },
{ url: "https://soundcloud.com/the-seahorses/love-is-the-law-album-version", answer: "The Seahorses - Love Is The Law" },
{ url: "https://soundcloud.com/the-bluetones/slight-return", answer: "The Bluetones - Slight Return" },
{ url: "https://soundcloud.com/the-stone-roses/somethings-burning-full-length", answer: "The Stone Roses - Something's Burning" },
{ url: "https://soundcloud.com/paulwellerofficial/broken-stones", answer: "Paul Weller - Broken Stones", startAtMs: 500 },
{ url: "https://soundcloud.com/pulp-official/mis-shapes", answer: "Pulp - Mis-Shapes", startAtMs: 900 },
{ url: "https://soundcloud.com/cornershop/brimful-of-asha-1", answer: "Cornershop - Brimful of Asha" },
{ url: "https://soundcloud.com/oasisofficial/whatever", answer: "Oasis - Whatever" },
{ url: "https://soundcloud.com/jeepster-1/belle-sebastian-the-boy-with-the-arab-strap", answer: "Belle & Sebastian - The Boy With The Arab Strap" },
{ url: "https://soundcloud.com/doves-official/pounding", answer: "Doves - Pounding", title: "Britpopple Disco 2000s", shareTags: "@Britpopple #Disco2000s #Heardle" },
{ url: "https://soundcloud.com/james-the-band/come-home", answer: "James - Come Home", title: "Britpopple 80s 80s 80s", shareTags: "@Britpopple #80s80s80s #Heardle" },
{ url: "https://soundcloud.com/northernuproar-music/from-a-window", answer: "Northern Uproar - From a Window", startAtMs: 1200 },
{ url: "https://soundcloud.com/space-the-band/neighbourhood-1", answer: "Space - Neighbourhood", startAtMs: 1000 },
{ url: "https://soundcloud.com/pulp-official/something-changed", answer: "Pulp - Something Changed" },
{ url: "https://soundcloud.com/the-stone-roses/she-bangs-the-drums-remastered", answer: "The Stone Roses - She Bangs the Drums", title: "Britpopple 80s 80s 80s", shareTags: "@Britpopple #80s80s80s #Heardle" },
{ url: "https://soundcloud.com/mylifestory/sparkle", answer: "My Life Story - Sparkle" },
{ url: "https://soundcloud.com/suede-official/beautiful-ones-1", answer: "Suede - Beautiful Ones", startAtMs: 250 },
{ url: "https://soundcloud.com/thecharlatans/just-lookin", answer: "The Charlatans - Just Lookin'" },
{ url: "https://soundcloud.com/mansun-official/stripper-vicar-1", answer: "Mansun - Stripper Vicar" },
{ url: "https://soundcloud.com/primalscream/star", answer: "Primal Scream - Star" },
{ url: "https://soundcloud.com/the-stone-roses/made-of-stone-remastered", answer: "The Stone Roses - Made of Stone" },
{ url: "https://soundcloud.com/radiohead/fake-plastic-trees", answer: "Radiohead - Fake Plastic Trees" },
{ url: "https://soundcloud.com/lush-official/single-girl", answer: "Lush - Single Girl", startAtMs: 250 },
{ url: "https://soundcloud.com/pulp-official/sorted-for-es-wizz", answer: "Pulp - Sorted For E's & Wizz", startAtMs: 8500 },
{ url: "https://soundcloud.com/the-verve-official/history", answer: "The Verve - History" },
{ url: "https://soundcloud.com/supergrass-official/sun-hits-the-sky", answer: "Supergrass - Sun Hits The Sky" },
{ url: "https://soundcloud.com/ash/oh-yeah-2011-remastered", answer: "ASH - Oh Yeah" },
{ url: "https://soundcloud.com/thechemicalbrothers/setting-sun", answer: "The Chemical Brothers - Setting Sun" },
{ url: "https://soundcloud.com/blurofficial/on-your-own", answer: "Blur - On Your Own" },
{ url: "https://soundcloud.com/strangelove-official/the-greatest-show-on-earth", answer: "Strangelove - The Greatest Show On Earth", startAtMs: 13500 },
{ url: "https://soundcloud.com/embrace-93530/the-good-will-out", answer: "Embrace - The Good Will Out" },
{ url: "https://soundcloud.com/echobellymusic/king-of-the-kerb", answer: "Echobelly - King of the Kerb", startAtMs: 3000 },
{ url: "https://soundcloud.com/elastica-official/vaseline-1", answer: "Elastica - Vaseline" },
{ url: "https://soundcloud.com/manicstreetpreachers/la-tristesse-durera-scream-to", answer: "Manic Street Preachers - La Tristesse Durera (Scream to a Sigh)" },
{ url: "https://soundcloud.com/the-boo-radleys/wake-up-boo-radio-edit", answer: "The Boo Radleys - Wake up Boo!", startAtMs: 500 },
{ url: "https://soundcloud.com/james-the-band/tomorrow-1", answer: "James - Tomorrow" },
{ url: "https://soundcloud.com/the-stone-roses/i-am-the-resurrection", answer: "The Stone Roses - I Am the Resurrection" },
{ url: "https://soundcloud.com/shed-seven/bully-boy", answer: "Shed Seven - Bully Boy" },
{ url: "https://soundcloud.com/cast-official/alright", answer: "Cast - Alright", startAtMs: 300 },
{ url: "https://soundcloud.com/the-bunnymen/nothing-lasts-forever-2", answer: "Echo And The Bunnymen - Nothing Lasts Forever", startAtMs: 200 },
{ url: "https://soundcloud.com/sleeperofficial/statuesque", answer: "Sleeper - Statuesque" },
{ url: "https://soundcloud.com/catatoniaofficial/catatonia-road-rage", answer: "Catatonia - Road Rage", startAtMs: 650 },
{ url: "https://soundcloud.com/oasisofficial/slide-away-1", answer: "Oasis - Slide Away" },
{ url: "https://soundcloud.com/gorkys-zygotic-mynci/patio-song", answer: "Gorky's Zygotic Mynci - Patio Song" },
{ url: "https://soundcloud.com/happy-mondays-official/kinky-afro-2", answer: "Happy Mondays - Kinky Afro" },
{ url: "https://soundcloud.com/electronicofficial/for-you-radio-edit", answer: "Electronic - For You" },
{ url: "https://soundcloud.com/super-furry-animals/god-show-me-magic-2016", answer: "Super Furry Animals - God! Show Me Magic" },
{ url: "https://soundcloud.com/inspiralcarpetsmusic/dragging-me-down", answer: "Inspiral Carpets - Dragging Me Down" },
{ url: "https://soundcloud.com/gene-official/for-the-dead", answer: "Gene - For The Dead" },
{ url: "https://soundcloud.com/the-verve-official/sonnet-1", answer: "The Verve - Sonnet" },
{ url: "https://soundcloud.com/blurofficial/chemical-world-including", answer: "Blur - Chemical World" },
{ url: "https://soundcloud.com/dodgy-official/melodies-haunt-you", answer: "Dodgy - Melodies Haunt You" },
{ url: "https://soundcloud.com/the-bluetones/marblehead-johnson", answer: "The Bluetones - Marblehead Johnson" },
{ url: "https://soundcloud.com/kula-shaker-official/hush-2011-remastered", answer: "Kula Shaker - Hush" },
{ url: "https://soundcloud.com/thecharlatans/how-high", answer: "The Charlatans - How High" },
{ url: "https://soundcloud.com/kenickieofficial/punka", answer: "Kenickie - Punka" },
{ url: "https://soundcloud.com/thechemicalbrothers/life-is-sweet", answer: "The Chemical Brothers - Life Is Sweet" },
{ url: "https://soundcloud.com/suede-official/filmstar-2", answer: "Suede - Filmstar", startAtMs: 500 },
{ url: "https://soundcloud.com/oasisofficial/supersonic-3", answer: "Oasis - Supersonic" },
{ url: "https://soundcloud.com/monaco-official/what-do-you-want-from-me-album", answer: "Monaco - What Do You Want From Me?", startAtMs: 350 },
{ url: "https://soundcloud.com/space-the-band/the-ballad-of-tom-jones-with", answer: "Space - The Ballad of Tom Jones" },
{ url: "https://soundcloud.com/shed-seven/speakeasy", answer: "Shed Seven - Speakeasy" },
{ url: "https://soundcloud.com/supergrass-official/mansize-rooster", answer: "Supergrass - Mansize Rooster" },
{ url: "https://soundcloud.com/blurofficial/parklife-2012-remastered", answer: "Blur - Parklife" },
{ url: "https://soundcloud.com/menswearofficial/stardust", answer: "Menswear - Stardust" },
{ url: "https://soundcloud.com/terrorvision-official/perseverance", answer: "Terrorvision - Perseverance" },
{ url: "https://soundcloud.com/thesmiths/panic-2008-remastered-version", answer: "The Smiths - Panic", startAtMs: 600, title: "Britpopple 80s 80s 80s", shareTags: "@Britpopple #80s80s80s #Heardle" },
{ url: "https://soundcloud.com/black-grape/reverend-black-grape", answer: "Black Grape - Reverend Black Grape", startAtMs: 1000 },
{ url: "https://soundcloud.com/ocean-colour-scene-official/the-day-we-caught-the-train-2", answer: "Ocean Colour Scene - The Day We Caught The Train" },
{ url: "https://soundcloud.com/saint-etienne/only-love-can-break-your-1", answer: "Saint Etienne - Only Love Can Break Your Heart" },
{ url: "https://soundcloud.com/radiohead/karma-police", answer: "Radiohead - Karma Police" },
{ url: "https://soundcloud.com/longpigs/lost-myself-album-version", answer: "Longpigs - Lost Myself", startAtMs: 700 },
{ url: "https://soundcloud.com/neworderofficial/world-in-motion", answer: "New Order - World in Motion" },
{ url: "https://soundcloud.com/blurofficial/this-is-a-low-2012-remastered", answer: "Blur - This Is a Low", startAtMs: 6000 },
{ url: "https://soundcloud.com/catatoniaofficial/youve-got-a-lot-to-answer-for", answer: "Catatonia - You've Got a Lot to Answer For", startAtMs: 700 },
{ url: "https://soundcloud.com/oasisofficial/rock-n-roll-star-1", answer: "Oasis - Rock 'n' Roll Star", startAtMs: 300 },
{ url: "https://soundcloud.com/travistheband/tied-to-the-90s", answer: "Travis - Tied To The 90's" },
{ url: "https://soundcloud.com/the-bluetones/bluetonic", answer: "The Bluetones - Bluetonic", startAtMs: 3500 },
{ url: "https://soundcloud.com/primalscream/movin-on-up-2", answer: "Primal Scream - Movin' on Up", startAtMs: 250 },
{ url: "https://soundcloud.com/james-the-band/ring-the-bells", answer: "James - Ring The Bells" },
{ url: "https://soundcloud.com/mansun-official/take-it-easy-chicken-2", answer: "Mansun - Take It Easy Chicken" },
{ url: "https://soundcloud.com/manicstreetpreachers/everything-must-go-remastered", answer: "Manic Street Preachers - Everything Must Go" },
{ url: "https://soundcloud.com/cast-official/guiding-star", answer: "Cast - Guiding Star" },
{ url: "https://soundcloud.com/marion-official/sleep", answer: "Marion - Sleep" },
{ url: "https://soundcloud.com/stereophonicsofficial/a-thousand-trees-1", answer: "Stereophonics - A Thousand Trees" },
{ url: "https://soundcloud.com/the-las/there-she-goes", answer: "The La's - There She Goes" },
{ url: "https://soundcloud.com/ash/kung-fu-2008-remastered", answer: "ASH - Kung Fu" },
{ url: "https://soundcloud.com/the-house-of-love/shine-on", answer: "The House Of Love - Shine On", title: "Britpopple 80s 80s 80s", shareTags: "@Britpopple #80s80s80s #Heardle" },
{ url: "https://soundcloud.com/thecharlatans/weirdo", answer: "The Charlatans - Weirdo" },
{ url: "https://soundcloud.com/inspiralcarpetsmusic/saturn-5", answer: "Inspiral Carpets - Saturn 5" },
{ url: "https://soundcloud.com/dodgy-official/in-a-room-full-version", answer: "Dodgy - In A Room" },
{ url: "https://soundcloud.com/space-the-band/avenging-angels-1", answer: "Space - Avenging Angels" },
{ url: "https://soundcloud.com/suede-official/metal-mickey-1", answer: "Suede - Metal Mickey", startAtMs: 1000 },
{ url: "https://soundcloud.com/the-stone-roses/mersey-paradise-remastered", answer: "The Stone Roses - Mersey Paradise" },
{ url: "https://soundcloud.com/kingmaker-official/ten-years-asleep", answer: "Kingmaker - Ten Years Asleep" },
{ url: "https://soundcloud.com/shed-seven/where-have-you-been-tonight-3", answer: "Shed Seven - Where Have You Been Tonight" },
{ url: "https://soundcloud.com/babybird-official/youre-gorgeous", answer: "Babybird - You're Gorgeous" },
{ url: "https://soundcloud.com/pulp-official/common-people-full-length", answer: "Pulp - Common People" },
{ url: "https://soundcloud.com/electronicofficial/forbidden-city-1", answer: "Electronic - Forbidden City", startAtMs: 300 },
{ url: "https://soundcloud.com/massiveattack/teardrop", answer: "Massive Attack - Teardrop" },
{ url: "https://soundcloud.com/black-grape/kellys-heroes", answer: "Black Grape - Kelly's Heroes" },
{ url: "https://soundcloud.com/longpigs/far", answer: "Longpigs - Far" },
{ url: "https://soundcloud.com/supergrass-official/alright-2015-remastered", answer: "Supergrass - Alright" },
{ url: "https://soundcloud.com/the-bluetones/are-you-blue-or-are-you-blind", answer: "The Bluetones - Are You Blue Or Are You Blind?", startAtMs: 200 },
{ url: "https://soundcloud.com/thesmiths/this-charming-man-2011", answer: "The Smiths - This Charming Man" },
{ url: "https://soundcloud.com/lush-official/500-shake-baby-shake", answer: "Lush - 500 (Shake Baby Shake)" },
{ url: "https://soundcloud.com/james-the-band/laid", answer: "James - Laid" },
{ url: "https://soundcloud.com/oasisofficial/merry-xmas-everybody", answer: "Oasis - Merry Xmas Everybody" },
{ url: "https://soundcloud.com/terrorvision-official/oblivion", answer: "Terrorvision - Oblivion" },
{ url: "https://soundcloud.com/ocean-colour-scene-official/the-riverboat-song-album", answer: "Ocean Colour Scene - The Riverboat Song" },
{ url: "https://soundcloud.com/cast-official/walkaway-album-version", answer: "Cast - Walkaway" },
{ url: "https://soundcloud.com/sleeperofficial/inbetweener", answer: "Sleeper - Inbetweener", startAtMs: 700 },
{ url: "https://soundcloud.com/manicstreetpreachers/kevin-carter", answer: "Manic Street Preachers - Kevin Carter" },
{ url: "https://soundcloud.com/kenickieofficial/come-out-2-nite", answer: "Kenickie - Come out 2 Nite" },
{ url: "https://soundcloud.com/blurofficial/theres-no-other-way-single", answer: "Blur - There's No Other Way" },
{ url: "https://soundcloud.com/thelevellers/hope-street", answer: "The Levellers - Hope Street", startAtMs: 500 },
{ url: "https://soundcloud.com/catatoniaofficial/mulder-and-scully", answer: "Catatonia - Mulder and Scully" },
{ url: "https://soundcloud.com/hurricane-1-official/step-into-my-world-album-1", answer: "Hurricane #1 - Step Into My World" },
{ url: "https://soundcloud.com/thechemicalbrothers/let-forever-be", answer: "The Chemical Brothers - Let Forever Be" },
{ url: "https://soundcloud.com/mansun-official/wide-open-space-3", answer: "Mansun - Wide Open Space" },
{ url: "https://soundcloud.com/dodgy-official/if-youre-thinking-of-me-single", answer: "Dodgy - If You're Thinking Of Me" },
{ url: "https://soundcloud.com/ash/girl-from-mars-1", answer: "ASH - Girl From Mars" },
{ url: "https://soundcloud.com/geneva108211/no-one-speaks-remastered", answer: "Geneva - No One Speaks" },
{ url: "https://soundcloud.com/thecharlatans/just-when-youre-thinkin-things", answer: "The Charlatans - Just When You're Thinkin' Things Over" },
{ url: "https://soundcloud.com/teenagefanclub/aint-that-enough-album-version", answer: "Teenage Fanclub - Ain't That Enough" },
{ url: "https://soundcloud.com/space-the-band/female-of-the-species-radio-1", answer: "Space - Female of the Species", startAtMs: 500 },
{ url: "https://soundcloud.com/primalscream/rocks-2", answer: "Primal Scream - Rocks" },
{ url: "https://soundcloud.com/the-stone-roses/elephant-stone-2", answer: "The Stone Roses - Elephant Stone" },
{ url: "https://soundcloud.com/elastica-official/stutter-1", answer: "Elastica - Stutter" },
{ url: "https://soundcloud.com/shed-seven/going-for-gold", answer: "Shed Seven - Going For Gold", startAtMs: 250 },
{ url: "https://soundcloud.com/stereophonicsofficial/local-boy-in-the-photograph-2", answer: "Stereophonics - Local Boy In The Photograph" },
{ url: "https://soundcloud.com/idlewild-official/when-i-argue-i-see-shapes", answer: "Idlewild - When I Argue I See Shapes" },
{ url: "https://soundcloud.com/supergrass-official/going-out", answer: "Supergrass - Going Out" },
{ url: "https://soundcloud.com/menswearofficial/ill-manage-somehow-single", answer: "Menswear - I'll Manage Somehow", startAtMs: 500 },
{ url: "https://soundcloud.com/the-seahorses/love-me-and-leave-me", answer: "The Seahorses - Love Me And Leave Me" },
...
{ url: "https://soundcloud.com/courteeners/what-took-you-so-long-album", answer: "Courteeners - What Took You So Long?", title: "Britpopple Disco 2000s", shareTags: "@Britpopple #Disco2000s #Heardle" },
{ url: "https://soundcloud.com/arcticmonkeys/leave-before-the-lights-come", answer: "Arctic Monkeys - Leave Before The Lights Come On", title: "Britpopple Disco 2000s", shareTags: "@Britpopple #Disco2000s #Heardle" },
{ url: "https://soundcloud.com/the-bluetones/if", answer: "The Bluetones - If..." },
{ url: "https://soundcloud.com/ocean-colour-scene-official/travellers-tune-album-version", answer: "Ocean Colour Scene - Travellers Tune", startAtMs: 1000 },
...
{ url: "https://soundcloud.com/gene-official/sleep-well-tonight", answer: "Gene - Sleep Well Tonight" },
{ url: "https://soundcloud.com/james-the-band/shes-a-star", answer: "James - She's A Star" },
{ url: "https://soundcloud.com/suede-official/new-generation-2", answer: "Suede - New Generation", startAtMs: 500 },
{ url: "https://soundcloud.com/dodgy-official/good-enough", answer: "Dodgy - Good Enough" },
{ url: "https://soundcloud.com/the-stone-roses/waterfall-remastered", answer: "The Stone Roses - Waterfall" },
{ url: "https://soundcloud.com/sleeperofficial/nice-guy-eddie", answer: "Sleeper - Nice Guy Eddie" },
{ url: "https://soundcloud.com/radiohead/no-surprises", answer: "Radiohead - No Surprises" },
{ url: "https://soundcloud.com/super-furry-animals/play-it-cool-2017-remastered", answer: "Super Furry Animals - Play It Cool" },
{ url: "https://soundcloud.com/60ftdolls/stay-bbc-radio1-john-peel", answer: "60 Ft Dolls - Stay" },
{ url: "https://soundcloud.com/oasisofficial/cigarettes-alcohol-3", answer: "Oasis - Cigarettes & Alcohol" },
{ url: "https://soundcloud.com/cast-official/sandstorm", answer: "Cast - Sandstorm" },
{ url: "https://soundcloud.com/stereophonicsofficial/more-life-in-a-tramps-vest-1", answer: "Stereophonics - More Life In A Tramps Vest" },
{ url: "https://soundcloud.com/babybird-official/candy-girl", answer: "Babybird - Candy Girl" },
{ url: "https://soundcloud.com/pulp-official/underwear", answer: "Pulp - Underwear" },
{ url: "https://soundcloud.com/supergrass-official/caught-by-the-fuzz", answer: "Supergrass - Caught By The Fuzz" },
{ url: "https://soundcloud.com/marion-official/time", answer: "Marion - Time" },
{ url: "https://soundcloud.com/shed-seven/on-standby-1", answer: "Shed Seven - On Standby" },
{ url: "https://soundcloud.com/the-verve-official/bitter-sweet-symphony-1", answer: "The Verve - Bitter Sweet Symphony" },
{ url: "https://soundcloud.com/the-divine-comedy/national-express", answer: "The Divine Comedy - National Express" },
{ url: "https://soundcloud.com/gomez-official/whippin-piccadilly", answer: "Gomez - Whippin' Piccadilly" },
{ url: "https://soundcloud.com/the-seahorses/you-can-talk-to-me", answer: "The Seahorses - You Can Talk To Me", startAtMs: 500 },
{ url: "https://soundcloud.com/menswearofficial/daydreamer", answer: "Menswear - Daydreamer" },
{ url: "https://soundcloud.com/spiritualized-official/electricity-1", answer: "Spiritualized - Electricity" },
{ url: "https://soundcloud.com/elastica-official/waking-up-1", answer: "Elastica - Waking Up" },
{ url: "https://soundcloud.com/ocean-colour-scene-official/youve-got-it-bad-album-version", answer: "Ocean Colour Scene - You've Got It Bad" },
{ url: "https://soundcloud.com/saint-etienne/youre-in-a-bad-way", answer: "Saint Etienne - You're In A Bad Way" },
{ url: "https://soundcloud.com/paulwellerofficial/the-changingman-album-version", answer: "Paul Weller - The Changingman" },
{ url: "https://soundcloud.com/dubstar-official/anywhere-1", answer: "Dubstar - Anywhere" },
{ url: "https://soundcloud.com/manicstreetpreachers/a-design-for-life", answer: "Manic Street Preachers - A Design For Life" },
{ url: "https://soundcloud.com/the-bluetones/solomon-bites-the-worm", answer: "The Bluetones - Solomon Bites The Worm" },
{ url: "https://soundcloud.com/oasisofficial/all-around-the-world", answer: "Oasis - All Around The World" },
{ url: "https://soundcloud.com/planned_obsolescence/devils-haircut-album-version", answer: "Beck - Devils Haircut", title: "Britpopple World Tour", shareTags: "@Britpopple #WorldTour #Heardle" },
{ url: "https://soundcloud.com/thecardigans/lovefool-radio-edit", answer: "The Cardigans - Lovefool", title: "Britpopple World Tour", shareTags: "@Britpopple #WorldTour #Heardle" },
{ url: "https://soundcloud.com/hole-official/celebrity-skin-album-version", answer: "Hole - Celebrity Skin", startAtMs: 500, title: "Britpopple World Tour", shareTags: "@Britpopple #WorldTour #Heardle" },
{ url: "https://soundcloud.com/weezer/say-it-aint-so-album-version", answer: "Weezer - Say It Ain't So", title: "Britpopple World Tour", shareTags: "@Britpopple #WorldTour #Heardle" },
{ url: "https://soundcloud.com/the-wannadies/might-be-stars-radio-edit", answer: "The Wannadies - Might Be Stars", title: "Britpopple World Tour", shareTags: "@Britpopple #WorldTour #Heardle" },
{ url: "https://soundcloud.com/thelemonheads/if-i-could-talk-id-tell-you", answer: "The Lemonheads - If I Could Talk I'd Tell You", title: "Britpopple World Tour", shareTags: "@Britpopple #WorldTour #Heardle" },
{ url: "https://soundcloud.com/smashingpumpkins/tonight-tonight-1", answer: "The Smashing Pumpkins - Tonight, Tonight", title: "Britpopple World Tour", shareTags: "@Britpopple #WorldTour #Heardle" },
{ url: "https://soundcloud.com/pavementofficial/shady-lane", answer: "Pavement - Shady Lane", title: "Britpopple World Tour", shareTags: "@Britpopple #WorldTour #Heardle" },
{ url: "https://soundcloud.com/whale-official/hobo-humpin-slobo-babe", answer: "Whale - Hobo Humpin' Slobo Babe", title: "Britpopple World Tour", shareTags: "@Britpopple #WorldTour #Heardle" },
{ url: "https://soundcloud.com/beastieboys/sabotage-2009-digital-remaster", answer: "Beastie Boys - Sabotage", title: "Britpopple World Tour", shareTags: "@Britpopple #WorldTour #Heardle" },
{ url: "https://soundcloud.com/gene-official/fighting-fit", answer: "Gene - Fighting Fit" },
{ url: "https://soundcloud.com/sleeperofficial/what-do-i-do-now-1", answer: "Sleeper - What Do I Do Now" },
{ url: "https://soundcloud.com/thecharlatans/the-charlatans-then-remastered", answer: "The Charlatans - Then" },
{ url: "https://soundcloud.com/the-stone-roses/love-spreads", answer: "The Stone Roses - Love Spreads" },
{ url: "https://soundcloud.com/suede-official/the-drowners-2", answer: "Suede - The Drowners", startAtMs: 1000 },
{ url: "https://soundcloud.com/shed-seven/getting-better", answer: "Shed Seven - Getting Better", startAtMs: 2500 },
{ url: "https://soundcloud.com/oasisofficial/bring-it-on-down-remastered", answer: "Oasis - Bring It On Down" },
{ url: "https://soundcloud.com/radiohead/just", answer: "Radiohead - Just", startAtMs: 1900 },
{ url: "https://soundcloud.com/manicstreetpreachers/you-stole-the-sun-from-my", answer: "Manic Street Preachers - You Stole the Sun from My Heart" },
{ url: "https://soundcloud.com/menswearofficial/being-brave", answer: "Menswear - Being Brave" },
{ url: "https://soundcloud.com/ocean-colour-scene-official/the-circle-album-version", answer: "Ocean Colour Scene - The Circle", startAtMs: 700 },
{ url: "https://soundcloud.com/cast-official/flying", answer: "Cast - Flying", startAtMs: 500 },
{ url: "https://soundcloud.com/the-stone-roses/begging-you", answer: "The Stone Roses - Begging You", startAtMs: 5000 },
{ url: "https://soundcloud.com/thecharlatans/the-charlatans-the-only-one-2", answer: "The Charlatans - The Only One I Know", startAtMs: 700 },
{ url: "https://soundcloud.com/james-the-band/sit-down", answer: "James - Sit Down" },
{ url: "https://soundcloud.com/the-las/feelin", answer: "The La's - Feelin'" },
{ url: "https://soundcloud.com/blurofficial/bank-holiday-2012-remastered", answer: "Blur - Bank Holiday" },
{ url: "https://soundcloud.com/paulwellerofficial/peacock-suit-single-album", answer: "Paul Weller - Peacock Suit" },
{ url: "https://soundcloud.com/the-verve-official/lucky-man-1", answer: "The Verve - Lucky Man", startAtMs: 1000 },
{ url: "https://soundcloud.com/dodgy-official/making-the-most-of", answer: "Dodgy - Making The Most Of.." },
{ url: "https://soundcloud.com/stereophonicsofficial/the-bartender-and-the-thief-1", answer: "Stereophonics - The Bartender And The Thief" },
{ url: "https://soundcloud.com/embrace-93530/come-back-to-what-you-know-1", answer: "Embrace - Come Back To What You Know" },
{ url: "https://soundcloud.com/suede-official/so-young-1", answer: "Suede - So Young", startAtMs: 700 },
{ url: "https://soundcloud.com/shed-seven/she-left-me-on-friday", answer: "Shed Seven - She Left Me On Friday" },
{ url: "https://soundcloud.com/space-the-band/begin-again-2", answer: "Space - Begin Again" },
{ url: "https://soundcloud.com/audience-official/a-pessimist-is-never", answer: "Theaudience - A Pessimist Is Never Disappointed", startAtMs: 1000 },
{ url: "https://soundcloud.com/catatoniaofficial/i-am-the-mob", answer: "Catatonia - I Am the Mob" },
{ url: "https://soundcloud.com/manicstreetpreachers/if-you-tolerate-this-your-1", answer: "Manic Street Preachers - If You Tolerate This Your Children Will Be Next" },
{ url: "https://soundcloud.com/cast-official/fine-time", answer: "Cast - Fine Time" },
{ url: "https://soundcloud.com/pulp-official/lipgloss", answer: "Pulp - Lipgloss", startAtMs: 1500 },
{ url: "https://soundcloud.com/black-grape/in-the-name-of-the-father", answer: "Black Grape - In The Name Of The Father", startAtMs: 9500 },
{ url: "https://soundcloud.com/ocean-colour-scene-official/hundred-mile-high-city-album", answer: "Ocean Colour Scene - Hundred Mile High City", startAtMs: 500 },
{ url: "https://soundcloud.com/oasisofficial/boneheads-bank-holiday", answer: "Oasis - Bonehead's Bank Holiday", startAtMs: 10500 },
{ url: "https://soundcloud.com/echobellymusic/dark-therapy", answer: "Echobelly - Dark Therapy" },
{ url: "https://soundcloud.com/james-the-band/destiny-calling", answer: "James - Destiny Calling" },
{ url: "https://soundcloud.com/rialtoofficial/monday-morning-5-19", answer: "Rialto - Monday Morning 5.19" },
{ url: "https://soundcloud.com/travistheband/all-i-want-to-do-is-rock", answer: "Travis - All I Want To Do Is Rock", startAtMs: 3000 },
{ url: "https://soundcloud.com/blurofficial/for-tomorrow-2012-remastered", answer: "Blur - For Tomorrow", startAtMs: 2500 },
{ url: "https://soundcloud.com/supergrass-official/lenny-2015-remastered-version", answer: "Supergrass - Lenny" },
{ url: "https://soundcloud.com/super-furry-animals/demons-2017-remastered-version", answer: "Super Furry Animals - Demons" },
{ url: "https://soundcloud.com/inspiralcarpetsmusic/i-want-you-feat-mark-e-smith-1", answer: "Inspiral Carpets - I Want You (feat. Mark E. Smith)" },
{ url: "https://soundcloud.com/the-divine-comedy/becoming-more-like-alfie-1", answer: "The Divine Comedy - Becoming More Like Alfie" },
{ url: "https://soundcloud.com/thelevellers/fantasy-remastered-version", answer: "Levellers - Fantasy", startAtMs: 1500 },
{ url: "https://soundcloud.com/ash/does-your-mother-know-2008", answer: "ASH - Does Your Mother Know" },
{ url: "https://soundcloud.com/sleeperofficial/atomic", answer: "Sleeper - Atomic" },
{ url: "https://soundcloud.com/manicstreetpreachers/raindrops-keep-falling-on-my", answer: "Manic Street Preachers - Raindrops Keep Fallin' On My Head" },
{ url: "https://soundcloud.com/suede-official/ship-building", answer: "Suede - Shipbuilding" },
{ url: "https://soundcloud.com/oasisofficial/cum-on-feel-the-noize", answer: "Oasis - Cum On Feel The Noize" },
{ url: "https://soundcloud.com/shed-seven/wired-for-sound", answer: "Shed Seven - Wired For Sound" },
{ url: "https://soundcloud.com/blurofficial/maggie-may-2012-remastered", answer: "Blur - Maggie May" },
{ url: "https://soundcloud.com/the-bluetones/woman-in-love", answer: "The Bluetones - Woman In Love" },
{ url: "https://soundcloud.com/ian-brown-official/billie-jean", answer: "Ian Brown - Billie Jean" },
{ url: "https://soundcloud.com/james-the-band/sunday-morning", answer: "James - Sunday Morning" },
{ url: "https://soundcloud.com/gomez-official/getting-better", answer: "Gomez - Getting Better" },
{ url: "https://soundcloud.com/supergrass-official/just-dropped-in-to-see-what-my", answer: "Supergrass - Just Dropped In (To See What My Condition Was In)" },
{ url: "https://soundcloud.com/dodgy-official/the-snake", answer: "Dodgy - The Snake" },
{ url: "https://soundcloud.com/thecharlatans/north-country-boy-remastered", answer: "The Charlatans - North Country Boy" },
{ url: "https://soundcloud.com/ocean-colour-scene-official/better-day-album-version", answer: "Ocean Colour Scene - Better Day" },
{ url: "https://soundcloud.com/embrace-93530/my-weakness-is-none-of-your", answer: "Embrace - My Weakness Is None Of Your Business" },
{ url: "https://soundcloud.com/marion-official/lets-all-go-together", answer: "Marion - Let's All Go Together" },
{ url: "https://soundcloud.com/salad-official/drink-the-elixir", answer: "Salad - Drink The Elixir", startAtMs: 750 },
{ url: "https://soundcloud.com/blurofficial/popscene-2012-remastered", answer: "Blur - Popscene", startAtMs: 5000 },
{ url: "https://soundcloud.com/cast-official/free-me", answer: "Cast - Free Me", startAtMs: 900 },
{ url: "https://soundcloud.com/manicstreetpreachers/tsunami-album-version", answer: "Manic Street Preachers - Tsunami" },
{ url: "https://soundcloud.com/kula-shaker-official/govinda-radio-mix", answer: "Kula Shaker - Govinda" },
{ url: "https://soundcloud.com/kenickieofficial/in-your-car", answer: "Kenickie - In Your Car", startAtMs: 800 },
{ url: "https://soundcloud.com/reefofficial/come-back-brighter", answer: "Reef - Come Back Brighter" },
{ url: "https://soundcloud.com/dodgy-official/so-let-me-go-far-radio-edit", answer: "Dodgy - So Let Me Go Far", startAtMs: 350 },
{ url: "https://soundcloud.com/radiohead/my-iron-lung", answer: "Radiohead - My Iron Lung" },
{ url: "https://soundcloud.com/the-bluetones/sleazy-bed-track", answer: "The Bluetones - Sleazy Bed Track" },
{ url: "https://soundcloud.com/paulwellerofficial/out-of-the-sinking", answer: "Paul Weller - Out Of The Sinking" },
{ url: "https://soundcloud.com/cable-official/freeze-the-atlantic", answer: "Cable - Freeze The Atlantic" },
{ url: "https://soundcloud.com/elastica-official/car-song-1", answer: "Elastica - Car Song", startAtMs: 4000 },
{ url: "https://soundcloud.com/james-the-band/sometimes", answer: "James - Sometimes" },
{ url: "https://soundcloud.com/tiger1-sc/race", answer: "Tiger - Race", startAtMs: 500 },
{ url: "https://soundcloud.com/pulp-official/razzamatazz", answer: "Pulp - Razzamatazz" },
{ url: "https://soundcloud.com/blurofficial/charmless-man", answer: "Blur - Charmless Man", startAtMs: 6550 },
{ url: "https://soundcloud.com/oasisofficial/acquiesce", answer: "Oasis - Acquiesce", startAtMs: 1100 },
...
{ url: "https://soundcloud.com/black-grape/shake-your-money", answer: "Black Grape - Shake Your Money" },
{ url: "https://soundcloud.com/thelevellers/what-a-beautiful-day", answer: "Levellers - What a Beautiful Day", startAtMs: 1750 },
{ url: "https://soundcloud.com/butilikeyou/bis-kandy-pop", answer: "bis - Kandy Pop" },
{ url: "https://soundcloud.com/blurofficial/the-universal-2012-remastered", answer: "Blur - The Universal", startAtMs: 1000 },
{ url: "https://soundcloud.com/puressence-official/this-feeling", answer: "Puressence - This Feeling" },
{ url: "https://soundcloud.com/the-divine-comedy/generation-sex", answer: "The Divine Comedy - Generation Sex", startAtMs: 500 },
{ url: "https://soundcloud.com/reefofficial/place-your-hands", answer: "Reef - Place Your Hands" },
{ url: "https://soundcloud.com/the-bluetones/cut-some-rug", answer: "The Bluetones - Cut Some Rug" },
{ url: "https://soundcloud.com/suede-official/stay-together", answer: "Suede - Stay Together", startAtMs: 1500 },
{ url: "https://soundcloud.com/catatoniaofficial/game-on", answer: "Catatonia - Game On" },
{ url: "https://soundcloud.com/longpigs/jesus-christ-album-version", answer: "Longpigs - Jesus Christ", startAtMs: 500 },
{ url: "https://soundcloud.com/oasisofficial/shes-electric", answer: "Oasis - She's Electric" },
{ url: "https://soundcloud.com/echobellymusic/the-world-is-flat-album", answer: "Echobelly - The World Is Flat" },
{ url: "https://soundcloud.com/stereophonicsofficial/just-looking-1", answer: "Stereophonics - Just Looking" },
{ url: "https://soundcloud.com/super-furry-animals/if-you-dont-want-me-to-destroy", answer: "Super Furry Animals - If You Don't Want Me To Destroy You" },
{ url: "https://soundcloud.com/mylifestory/strumpet", answer: "My Life Story - Strumpet" },
{ url: "https://soundcloud.com/gene-official/speak-to-me-someone", answer: "Gene - Speak To Me Someone" },
{ url: "https://soundcloud.com/blurofficial/beetlebum-2012-remastered", answer: "Blur - Beetlebum", startAtMs: 250 },
{ url: "https://soundcloud.com/travistheband/happy", answer: "Travis - Happy" },
{ url: "https://soundcloud.com/pulp-official/mile-end", answer: "Pulp - Mile End" },
{ url: "https://soundcloud.com/saint-etienne/i-was-born-on-christmas-day", answer: "Saint Etienne - I Was Born On Christmas Day" },
...
{ url: "https://soundcloud.com/manicstreetpreachers/some-kind-of-nothingness-1", answer: "Manic Street Preachers - Some Kind Of Nothingness (feat. Ian McCulloch)", title: "Britpopple Afterglow", shareTags: "@Britpopple #Afterglow #Heardle" },
{ url: "https://soundcloud.com/noelgallagher/holy-mountain-remastered", answer: "Noel Gallagher's High Flying Birds - Holy Mountain", title: "Britpopple Afterglow", shareTags: "@Britpopple #Afterglow #Heardle" },
{ url: "https://soundcloud.com/oasisofficial/lyla", answer: "Oasis - Lyla", title: "Britpopple Afterglow", shareTags: "@Britpopple #Afterglow #Heardle" },
{ url: "https://soundcloud.com/supergrass-official/grace-2023-remaster", answer: "Supergrass - Grace", title: "Britpopple Afterglow", shareTags: "@Britpopple #Afterglow #Heardle" },
{ url: "https://soundcloud.com/thecharlatans/impossible", answer: "The Charlatans - Impossible", title: "Britpopple Afterglow", shareTags: "@Britpopple #Afterglow #Heardle" },
{ url: "https://soundcloud.com/the-bluetones/never-going-nowhere", answer: "The Bluetones - Never Going Nowhere", title: "Britpopple Afterglow", shareTags: "@Britpopple #Afterglow #Heardle" },
{ url: "https://soundcloud.com/oasisofficial/digsys-dinner-remastered", answer: "Oasis - Digsy's Dinner" },
{ url: "https://soundcloud.com/cornershop/sleep-on-the-left-side-radio", answer: "Cornershop - Sleep On The Left Side", startAtMs: 900 },
{ url: "https://soundcloud.com/sleeperofficial/delicious", answer: "Sleeper - Delicious" },
{ url: "https://soundcloud.com/morrisseyofficial/the-more-you-ignore-me-the-4", answer: "Morrissey - The More You Ignore Me, the Closer I Get", startAtMs: 500 },
{ url: "https://soundcloud.com/suede-official/lazy-1", answer: "Suede - Lazy", startAtMs: 500 },
{ url: "https://soundcloud.com/cast-official/im-so-lonely", answer: "Cast - I'm So Lonely" },
{ url: "https://soundcloud.com/northernuproar-music/rollercoaster", answer: "Northern Uproar - Rollercoaster", startAtMs: 3400 },
{ url: "https://soundcloud.com/shed-seven/dolphin-chris-sheldon-mix", answer: "Shed Seven - Dolphin" },
{ url: "https://soundcloud.com/theshirehorses/now-i-know-where-im-going-our", answer: "The Shirehorses - Now I Know Where I'm Going Our Kid" },
{ url: "https://soundcloud.com/blurofficial/advert-2012-remastered-version", answer: "Blur - Advert" },
{ url: "https://soundcloud.com/gene-official/haunted-by-you", answer: "Gene - Haunted By You", startAtMs: 1000 },
{ url: "https://soundcloud.com/teenagefanclub/what-you-do-to-me-1", answer: "Teenage Fanclub - What You Do to Me" },
{ url: "https://soundcloud.com/the-dandy-warhols/not-if-you-were-the-last", answer: "The Dandy Warhols - Not If You Were The Last Junkie On Earth", startAtMs: 3950, title: "Britpopple World Tour", shareTags: "@Britpopple #WorldTour #Heardle" },
{ url: "https://soundcloud.com/thecardigans/carnival", answer: "The Cardigans - Carnival", startAtMs: 1000, title: "Britpopple World Tour", shareTags: "@Britpopple #WorldTour #Heardle" },
{ url: "https://soundcloud.com/planned_obsolescence/the-new-pollution-album", answer: "Beck - The New Pollution", title: "Britpopple World Tour", shareTags: "@Britpopple #WorldTour #Heardle" },
{ url: "https://soundcloud.com/thelemonheads/the-lemonheads-into-your-arms", answer: "The Lemonheads - Into Your Arms", title: "Britpopple World Tour", shareTags: "@Britpopple #WorldTour #Heardle" },
{ url: "https://soundcloud.com/smashingpumpkins/1979-1", answer: "The Smashing Pumpkins - 1979", startAtMs: 7600, title: "Britpopple World Tour", shareTags: "@Britpopple #WorldTour #Heardle" },
{ url: "https://soundcloud.com/pavementofficial/cut-your-hair", answer: "Pavement - Cut Your Hair", startAtMs: 1200, title: "Britpopple World Tour", shareTags: "@Britpopple #WorldTour #Heardle" },
{ url: "https://soundcloud.com/beastieboys/sure-shot-2009-digital", answer: "Beastie Boys - Sure Shot", title: "Britpopple World Tour", shareTags: "@Britpopple #WorldTour #Heardle" },
{ url: "https://soundcloud.com/vnjello/soundtracks-saints-row-iv-the-mix-1077-the-presidents-of-the-united-states-of-america-lump", answer: "The Presidents Of The United States Of America - Lump", startAtMs: 700, title: "Britpopple World Tour", shareTags: "@Britpopple #WorldTour #Heardle" },
{ url: "https://soundcloud.com/the-wannadies/you-and-me-song", answer: "The Wannadies - You And Me Song", title: "Britpopple World Tour", shareTags: "@Britpopple #WorldTour #Heardle" },
{ url: "https://soundcloud.com/foofighters/big-me-1", answer: "Foo Fighters - Big Me", title: "Britpopple World Tour", shareTags: "@Britpopple #WorldTour #Heardle" },
{ url: "https://soundcloud.com/the-bluetones/down-at-the-reservoir", answer: "The Bluetones - Down At The Reservoir" },
{ url: "https://soundcloud.com/baddielskinnerlightningseeds/three-lions", answer: "Baddiel, Skinner & Lightning Seeds  - Three Lions" },
{ url: "https://soundcloud.com/the-verve-official/the-drugs-dont-work-1", answer: "The Verve - The Drugs Don't Work" },
{ url: "https://soundcloud.com/morrisseyofficial/dagenham-dave-1", answer: "Morrissey - Dagenham Dave" },
{ url: "https://soundcloud.com/the-coral/dreaming-of-you", answer: "The Coral - Dreaming of You", title: "Britpopple Disco 2000s", shareTags: "@Britpopple #Disco2000s #Heardle" },
{ url: "https://soundcloud.com/grahamcoxonofficial/freakin-out-1", answer: "Graham Coxon - Freakin' Out", title: "Britpopple Disco 2000s", shareTags: "@Britpopple #Disco2000s #Heardle" },
{ url: "https://soundcloud.com/editorsofficial/blood", answer: "Editors - Blood", title: "Britpopple Disco 2000s", shareTags: "@Britpopple #Disco2000s #Heardle" },
{ url: "https://soundcloud.com/kooksmusic/she-moves-in-her-own-way", answer: "The Kooks - She Moves In Her Own Way", title: "Britpopple Disco 2000s", shareTags: "@Britpopple #Disco2000s #Heardle" },
{ url: "https://soundcloud.com/franzferdinand/darts-of-pleasure-1", answer: "Franz Ferdinand - Darts Of Pleasure", startAtMs: 700, title: "Britpopple Disco 2000s", shareTags: "@Britpopple #Disco2000s #Heardle" },
{ url: "https://soundcloud.com/the-libertines-official/up-the-bracket", answer: "The Libertines - Up The Bracket", title: "Britpopple Disco 2000s", shareTags: "@Britpopple #Disco2000s #Heardle" },
{ url: "https://soundcloud.com/blocparty/banquet-1", answer: "Bloc Party - Banquet", startAtMs: 6900, title: "Britpopple Disco 2000s", shareTags: "@Britpopple #Disco2000s #Heardle" },
{ url: "https://soundcloud.com/kasabianofficial/processed-beats", answer: "Kasabian - Processed Beats", title: "Britpopple Disco 2000s", shareTags: "@Britpopple #Disco2000s #Heardle" },
{ url: "https://soundcloud.com/kaiserchiefs/i-predict-a-riot-1", answer: "Kaiser Chiefs - I Predict A Riot", title: "Britpopple Disco 2000s", shareTags: "@Britpopple #Disco2000s #Heardle" },
{ url: "https://soundcloud.com/northernuproar-music/town", answer: "Northern Uproar - Town" },
{ url: "https://soundcloud.com/skunk-anansie-official/charity-1", answer: "Skunk Anansie - Charity", startAtMs: 8000 },
{ url: "https://soundcloud.com/dodgy-official/found-you", answer: "Dodgy - Found You" },
{ url: "https://soundcloud.com/sleeperofficial/shes-a-good-girl", answer: "Sleeper - She's a Good Girl" },
{ url: "https://soundcloud.com/sleeperofficial/romeo-me", answer: "Sleeper - Romeo Me" },
{ url: "https://soundcloud.com/joy-division-3/love-will-tear-us-apart", answer: "Joy Division - Love Will Tear Us Apart", title: "Britpopple 80s 80s 80s", shareTags: "@Britpopple #80s80s80s #Heardle" },
{ url: "https://soundcloud.com/the-jam-official/start-remastered", answer: "The Jam - Start!", title: "Britpopple 80s 80s 80s", shareTags: "@Britpopple #80s80s80s #Heardle" },
{ url: "https://soundcloud.com/the-bunnymen/the-killing-moon-1", answer: "Echo And The Bunnymen - The Killing Moon", title: "Britpopple 80s 80s 80s", shareTags: "@Britpopple #80s80s80s #Heardle" },
{ url: "https://soundcloud.com/thecureofficial/in-between-days", answer: "The Cure - In Between Days", title: "Britpopple 80s 80s 80s", shareTags: "@Britpopple #80s80s80s #Heardle" },
{ url: "https://soundcloud.com/primalscream/velocity-girl-janice-long-bbc", answer: "Primal Scream - Velocity Girl", title: "Britpopple 80s 80s 80s", shareTags: "@Britpopple #80s80s80s #Heardle" },
{ url: "https://soundcloud.com/happy-mondays-official/24-hour-party-people", answer: "Happy Mondays - 24 Hour Party People", title: "Britpopple 80s 80s 80s", shareTags: "@Britpopple #80s80s80s #Heardle" },
{ url: "https://soundcloud.com/blurofficial/tracy-jacks-2012-remastered", answer: "Blur - Tracy Jacks" },
{ url: "https://soundcloud.com/oasisofficial/some-might-say-remastered", answer: "Oasis - Some Might Say" },
{ url: "https://soundcloud.com/oasisofficial/sad-song-remastered", answer: "Oasis - Sad Song" },
{ url: "https://soundcloud.com/theclash/london-calling-remastered", answer: "The Clash - London Calling", startAtMs: 100, title: "Britpopple London Calling", shareTags: "@Britpopple #LondonCalling #Heardle" },
{ url: "https://soundcloud.com/davidbowieofficial/lets-dance-single-version-2002", answer: "David Bowie - Let's Dance", title: "Britpopple London Calling", shareTags: "@Britpopple #LondonCalling #Heardle" },
{ url: "https://soundcloud.com/jamietmusic/sticks-n-stones", answer: "Jamie T - Sticks 'N' Stones", title: "Britpopple London Calling", shareTags: "@Britpopple #LondonCalling #Heardle" },
{ url: "https://soundcloud.com/squeeze3/up-the-junction", answer: "Squeeze - Up The Junction", title: "Britpopple London Calling", shareTags: "@Britpopple #LondonCalling #Heardle" },
{ url: "https://soundcloud.com/wolfalice/dont-delete-the-kisses", answer: "Wolf Alice - Don't Delete The Kisses", startAtMs: 6000, title: "Britpopple London Calling", shareTags: "@Britpopple #LondonCalling #Heardle" },
{ url: "https://soundcloud.com/madnessofficial/embarrassment-4", answer: "Madness - Embarrassment", title: "Britpopple London Calling", shareTags: "@Britpopple #LondonCalling #Heardle" },
{ url: "https://soundcloud.com/the-jam-official/going-underground", answer: "The Jam - Going Underground", title: "Britpopple London Calling", shareTags: "@Britpopple #LondonCalling #Heardle" },
{ url: "https://soundcloud.com/sexpistolsofficial/anarchy-in-the-uk-remastered", answer: "Sex Pistols - Anarchy In The UK", title: "Britpopple London Calling", shareTags: "@Britpopple #LondonCalling #Heardle" },
{ url: "https://soundcloud.com/the-maccabees/pelican", answer: "The Maccabees - Pelican", title: "Britpopple London Calling", shareTags: "@Britpopple #LondonCalling #Heardle" },
{ url: "https://soundcloud.com/rolling-stones-official/rocks-off", answer: "The Rolling Stones - Rocks Off", title: "Britpopple London Calling", shareTags: "@Britpopple #LondonCalling #Heardle" },
{ url: "https://soundcloud.com/thecharlatans/jesus-hairdo", answer: "The Charlatans - Jesus Hairdo" },
{ url: "https://soundcloud.com/blurofficial/sunday-sunday-2012-remastered", answer: "Blur - Sunday Sunday" },
{ url: "https://soundcloud.com/suede-official/the-wild-ones", answer: "Suede - The Wild Ones" },
{ url: "https://soundcloud.com/shed-seven/devil-in-your-shoes-1", answer: "Shed Seven - Devil In Your Shoes" },
{ url: "https://soundcloud.com/themikeflowerspops/wonderwall-2", answer: "The Mike Flowers Pops - Wonderwall", startAtMs: 2700 },
{ url: "https://soundcloud.com/primalscream/burning-wheel-remastered", answer: "Primal Scream - Burning Wheel" },
{ url: "https://soundcloud.com/smashingpumpkins/today", answer: "The Smashing Pumpkins - Today", title: "Britpopple World Tour", shareTags: "@Britpopple #WorldTour #Heardle" },
{ url: "https://soundcloud.com/harvey-danger-official/flagpole-sitta", answer: "Harvey Danger - Flagpole Sitta", title: "Britpopple World Tour", shareTags: "@Britpopple #WorldTour #Heardle" },
{ url: "https://soundcloud.com/gigoloaunts-music/where-i-find-my-heaven", answer: "Gigolo Aunts - Where I Find My Heaven", title: "Britpopple World Tour", shareTags: "@Britpopple #WorldTour #Heardle" },
{ url: "https://soundcloud.com/ben-folds-five/underground", answer: "Ben Folds Five - Underground", title: "Britpopple World Tour", shareTags: "@Britpopple #WorldTour #Heardle" },
{ url: "https://soundcloud.com/thebreeders/cannonball", answer: "The Breeders - Cannonball", startAtMs: 9100, title: "Britpopple World Tour", shareTags: "@Britpopple #WorldTour #Heardle" },
...
const SongOfTheDay = () => Songbook[Playlist[SongId(Vt.startDate)]];
    ...
    return {
      c() {
        ...
        Q(l.$$.fragment),
          ...
          (C = x()),
          H && H.c(),
          (An.title = "Britpopple - Heardle for Britpop fans"),
          M(t, "name", "description"),
          M(
            t,
            "content",
            "Love Britpop? Name that British indie pop song from the intro as quickly as you can"
          ),
  ...
  function jn(e, t, n) {
    ...
    let a = x(Vt.startDate),
      l = {
        url: s[Playlist[a]].url,
        correctAnswer: s[Playlist[a]].answer,
        startAtMs: s[Playlist[a]].startAtMs || 0,
        id: a,
        guessList: [],
        hasFinished: !1,
        hasStarted: !1,
    ...
    return [
      ...
      function(e) {
        ...
        n(2, (l.artist = l.correctAnswer.split(" - ")[1]), l),
          ...
          (function(e, t, n) {
            e.set(n);
          })(Cn, (r = [...r]), r), // })(Cn, (r = [...r, l.correctAnswer]), r), --- stop correct answer appearing twice in drop down
          n(9, (y = r)),
